...
Love Becomes a Masterpiece</p>
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex justify-center md:justify-end gap-3">
              ...
              <a href="https://www.youtube.com/@serenityweddingfilms" target="_blank" rel="noopener noreferrer" className="w-12 h-12 border border-cream/20 flex items-center justify-center text-cream/60 hover:text-cream hover:border-cream/40 transition-all duration-300" aria-label="YouTube">
                <Youtube className="w-5 h-5" />
              </a>
              <a href="https://tiktok.com/@serenityweddingfilms?_t=8hmv9VTaBx1&_r=1" target="_blank" rel="noopener noreferrer" className="w-12 h-12 border border-cream/20 flex items-center justify-center text-cream/60 hover:text-cream hover:border-cream/40 transition-all duration-300" aria-label="TikTok">
