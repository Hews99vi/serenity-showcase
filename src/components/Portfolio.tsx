  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Location badge */}
        {video.location && (
          <div className="absolute top-4 left-4 flex items-center gap-2 px-3 py-1.5 bg-charcoal/80 backdrop-blur-sm border border-cream/20">
      ...
      >
        {video.couple && (
          <p className="text-cream/90 font-serif text-lg mb-2">{video.couple}</p>
        )}
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className={`absolute inset-0 transition-all duration-500 ${
          isActive 
            ? "bg-gradient-to-t from-charcoal/95 via-charcoal/80 to-charcoal/60" 
            : "bg-gradient-to-t from-charcoal/90 via-charcoal/70 to-charcoal/40 group-hover:from-charcoal/95 group-hover:via-charcoal/75"
        }`} />
      </div>
      ...
      <div className="relative z-10 p-6 md:p-8 h-full flex flex-col justify-end min-h-[280px] md:min-h-[320px]">
        ...
        <motion.div
          className={`w-12 h-12 rounded-full flex items-center justify-center mb-4 transition-all duration-300 ${
            isActive ? "bg-cream/20" : "bg-cream/10 group-hover:bg-cream/20"
          }`}
        ...
        {/* Title */}
        <h3 className={`font-serif text-xl md:text-2xl mb-3 transition-colors duration-300 ${
          isActive ? "text-cream" : "text-cream/90 group-hover:text-cream"
        }`}>
          {category.title}
        </h3>
        ...
        {/* Active indicator */}
        <motion.div
          className="absolute bottom-0 left-0 h-1 bg-cream/60"
          initial={{ width: 0 }}
        ...
        {/* Corner accent */}
        <div className={`absolute top-4 right-4 w-8 h-8 border-t border-r transition-all duration-300 ${
          isActive ? "border-cream/40" : "border-cream/20 group-hover:border-cream/40"
        }`} />
      </div>
    </motion.div>
  );
