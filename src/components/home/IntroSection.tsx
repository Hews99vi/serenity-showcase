      ...
      <div className="section-container">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <h2 className="text-3xl md:text-4xl font-serif text-cream leading-tight mb-8 animate-fade-up animation-delay-200 tracking-wide uppercase text-left lg:text-3xl">A NEW CHAPTER IN SERENITY</h2>
          ...
          <div className="relative flex justify-center lg:justify-end animate-fade-up animation-delay-400">
            <div className="relative">
              ...
              <div className="relative w-[280px] h-[500px] rounded-xl overflow-hidden shadow-2xl">
                <iframe src="https://www.youtube.com/embed/HErj8tqko3M?autoplay=1&mute=1&loop=1&playlist=HErj8tqko3M&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1" title="Serenity Wedding Films Reel" className="w-full h-full" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
              </div>
