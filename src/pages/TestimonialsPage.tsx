...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    fullQuote:
      "Serenity Wedding Films understood exactly what we wanted—a film that felt like US. The cinematography was stunning and exceeded our expectations. They have an incredible ability to capture raw emotions and genuine moments. Every time we watch our wedding film, we're transported back to that magical day.",
  ...
  },
  {
    ...
    fullQuote:
      "Every frame tells our story. The attention to detail and the creative vision exceeded everything we hoped for. From the first consultation to the final delivery, the experience was nothing short of magical. They understood our vision perfectly and translated it into a cinematic masterpiece.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Watch heartfelt testimonials from our couples. Real stories, real emotions captured in cinematic reels."
        />
      </Helmet>
      ...
      <main className="min-h-screen bg-charcoal">
        ...
        <section className="section-padding">
          ...
          >
            ...
            <a
              href="/contact"
              className="inline-flex items-center gap-3 px-8 py-4 bg-cream text-charcoal font-medium tracking-wide hover:bg-cream/90 transition-all duration-300 group rounded-sm"
            >
              Get in Touch
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0 bg-gradient-to-br from-cream/8 to-cream/4 border border-cream/10">
                ...
                <div className="relative aspect-[9/16] md:aspect-auto md:h-full min-h-[300px] md:min-h-[500px] bg-charcoal">
                  <iframe
                    src={`https://www.youtube.com/embed/${selectedTestimonial.youtubeId}?autoplay=0&controls=1&modestbranding=1&rel=0`}
                    className="absolute inset-0 w-full h-full"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
