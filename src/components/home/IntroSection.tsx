      ...
      <div className="section-container">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6 text-cream/80 text-lg md:text-xl leading-relaxed font-light animate-fade-up animation-delay-400">
            <p>
              We're stepping into a new chapter with a refreshed identity — crafted with elegance, 
            ...
            <p>
              From the intimate glances to the joyous celebrations, we're here to document every 
              precious moment of your special day — naturally, artistically, and with intention.
            </p>
          </div>
