    ...
    <footer className="relative bg-charcoal text-cream overflow-hidden">
      ...
      <div className="relative z-10 section-container py-20 md:py-24">
        ...
        <div className="text-center mb-16">
          ...
          />
          <motion.p 
            className="text-cream/50 font-serif text-lg md:text-xl italic tracking-wide max-w-md mx-auto"
            initial={{ opacity: 0 }}
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col gap-5">
              <motion.a 
                ...
                className="flex items-center justify-center gap-3 text-cream/50 hover:text-cream transition-colors duration-300 group"
              ...
              >
                ...
                <span className="text-sm">hello@serenityweddingfilms.com</span>
              </motion.a>
              <motion.div 
                className="flex items-center justify-center gap-3 text-cream/50"
                initial={{ opacity: 0, y: 10 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex justify-center md:justify-end gap-4">
              <motion.a 
                ...
                className="w-11 h-11 rounded-full border border-cream/15 flex items-center justify-center text-cream/50 hover:text-cream hover:border-gold/50 hover:bg-gold/10 transition-all duration-300" 
