      ...
      <div className="section-container">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-cream leading-tight mb-8 animate-fade-up animation-delay-200 tracking-wide uppercase text-left">A NEW CHAPTER IN SERENITY</h2>
